...
a.$elem=e('<div class="'+a.config.classes.contentWrapper+'" />');a.$window=e(d);a.$elem.append(a.$markup,a.$closeButton);a.events.bind();return a;},events:{bind:function(){a.$closeButton.add(a.$curtain).on("click.modal",a.handlers.click);
a.$window.on("keyup.modal",a.handlers.keyup);},unbind:function(){a.$closeButton.add(a.$curtain).off("click.modal");a.$window.off("keyup.modal");}},handlers:{click:function(g){g.preventDefault();
...
var g=setTimeout(function(){a.events.unbind();a.$curtain.add(a.$elem).remove();if(typeof a.config.callbacks.post=="function"){a.config.callbacks.post();
